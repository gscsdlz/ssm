...
--
-- Host: localhost:3306
-- Generation Time: 2018-10-24 14:19:56
-- 服务器版本： 5.7.19
-- PHP Version: 7.1.9
...
INSERT INTO `account` (`account_id`, `username`, `password`, `act`, `created_at`, `updated_at`)
VALUES (1,
        ''admin'',
...
INSERT INTO `alarm` (`alarm_id`, `warning_id`, `health_value`, `created_at`, `handle`)
VALUES (31, 5, 123, ''2018-10-18 20:15:25'', 0),
...
INSERT INTO `check_history` (`ch_id`,
                             `account_id`,
                             `hospital_name`,
                             `section`,
                             `check_name`,
                             ...
                             `doctor_id`,
                             `created_at`)
VALUES (1, 1, ''郫县人民医院'', ''骨科'', ''骨质疏松'', ''诊断骨质'', 3, ''2018-09-27 20:36:00'');
...
INSERT INTO `complaint` (`complaint_id`, `elder_id`, `content`, `created_at`, `handle`, `handle_content`, `handle_time`)
VALUES (2, 1, ''123'', ''2018-08-22 21:57:54'', 0, '''', NULL),
...
INSERT INTO `doctor_evaluate` (`evaluate_id`, `account_id`, `doctor_id`, `evaluate`, `suggest`, `created_at`)
VALUES (2, 1, 3, 4, ''你好'', ''2018-10-17 21:05:18''),
       (3, 1, 12, 1, ''身体还不错'', ''2018-10-24 20:41:03'');
...
INSERT INTO `doctor_user` (`account_id`,
                           `realname`,
                           `phone`,
                           `address`,
                           `hospital_name`,
...
VALUES (3,
       ...
       (12, ''小小孩'', ''10086'', ''北京'', ''北京'', ''儿科'', NULL, 0, 25, ''2018-10-24 20:37:57'', ''2018-10-24 20:38:27'');
...
INSERT INTO `drug_history` (`dh_id`,
                            `account_id`,
                            `hospital_name`,
                            `drug_name`,
                            `total_size`,
...
INSERT INTO `elder_user` (`account_id`,
                          `realname`,
                          `gender`,
                          `age`,
                          `address`,
...
INSERT INTO `family_user` (`account_id`, `realname`, `phone`, `address`, `created_at`, `updated_at`)
VALUES (7, ''老人家人'', ''18434343433'', ''北京市·朝阳区·四环'', ''2018-10-17 23:34:15'', ''2018-10-24 20:30:05''),
       (10, ''家庭测试'', ''12345678920'', ''中北大学'', ''2018-10-24 20:34:30'', ''2018-10-24 20:34:43'');
...
CREATE TABLE IF NOT EXISTS `follow` (
  ...
  UNIQUE KEY `account_id` (`account_id`, `family_id`)
)
  ENGINE = InnoDB
  AUTO_INCREMENT = 11
  DEFAULT CHARSET = utf8;
...
INSERT INTO `follow` (`follow_id`, `account_id`, `family_id`, `created_at`)
VALUES (3, 2, 7, ''2018-10-18 22:57:46''),
       (5, 1, 7, ''2018-10-24 20:26:57''),
       (9, 2, 10, ''2018-10-24 20:35:35'');
...
INSERT INTO `group_user` (`account_id`, `realname`, `phone`, `address`, `created_at`, `updated_at`)
VALUES (8, ''groupUser'', ''10086'', ''中国移动'', ''2018-10-17 23:35:17'', ''2018-10-23 20:23:29''),
       (11, ''社区测试'', ''1231'', ''123'', ''2018-10-24 20:36:24'', ''2018-10-24 20:36:42'');
...
INSERT INTO `health_data` (`data_id`, `data`, `account_id`, `type`, `created_at`)
VALUES (1, ''{\"systolic\": 123,\"diastolic\": 67,\"pulse\": 80}'', 1, 1, ''2018-09-24''),
...
(2, 1, 8, 2, ''测试'', 152, ''2018-12-24 '', ''2018-10-22 22:55:52''),
(3, 1, 11, 3, ''123'', 1, ''今天'', ''2018-10-24 20:37:25'');
