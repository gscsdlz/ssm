                ...
                <div class="col-xs-12 col-sm-3 col-sm-offset-1 center">
                    ...
                    <div class="center">
                         <span class="btn btn-app btn-sm btn-light no-hover">
                            <span class="line-height-1 bigger-170 blue" id="complaints"> 0 </span>
                            <br>
                            <span class="line-height-1 smaller-90"> 总投诉数量 </span>
                        </span>
                        ...
                        <span class="btn btn-app btn-sm btn-yellow no-hover">
                                <span class="line-height-1 bigger-170" id="workOrders"> 0 </span>
                                <br>
                                <span class="line-height-1 smaller-90"> 总工单数量 </span>
                        </span>
...
<script>
    ...
    $(document).ready(function () {
        $("#infoRow").userInfo({
            'data': infoData,
            'updateURL': '/group_user/update'
        });

        $.get("/user_count/group", function (response) {
            if (response.status) {
