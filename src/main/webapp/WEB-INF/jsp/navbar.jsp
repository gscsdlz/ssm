        ...
        <ul class="nav nav-list">
            ...
            <li>
                <a href="#" class="dropdown-toggle">
                    ...
                    <span class="menu-text"> 健康监测 </span>
                    <b class="arrow fa fa-angle-down"></b>
                </a>
                <b class="arrow"></b>
                <ul class="submenu">
                    <li>
                        <a href="tables.html"><i class="menu-icon fa fa-caret-right"></i>血压指标</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>血糖指标</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>身高体重指标</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>体温指标</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>睡眠指标</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>室内温度指标</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>室内湿度指标</a>
                        <b class="arrow"></b>
                    </li>
                </ul>
            </li>
            <li>
                <a href="#" class="dropdown-toggle">
                    ...
                    <span class="menu-text"> 健康监护 </span>
                    <b class="arrow fa fa-angle-down"></b>
                </a>
                <b class="arrow"></b>
                ...
                <ul class="submenu">
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>地图定位</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>异常指示</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>报警查询</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>预警设置</a>
                        <b class="arrow"></b>
                    </li>
                    <li>
                        <a href="jqgrid.html"><i class="menu-icon fa fa-caret-right"></i>提醒设置</a>
                        <b class="arrow"></b>
                    </li>
                </ul>
            </li>
